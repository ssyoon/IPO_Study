    ...
    def error_message(player: Player, values):
        if player.task_type == "Uniform":
            if values["attention_value_question"] == 2 and values["attention_price_question"] == 1 and values["attention_allocation_question"] == 50 and values["attention_earning_question"] == 50:
                ...
                return "You provided a wrong answer to Question 1. Please provide the correct answer to proceed. Market value is the number of High value signal + 1"
            elif values["attention_price_question"] != 1:
                return "You provided a wrong answer to Question 2. Please provide the correct answer to proceed. If the total quantity bid for in your group is less than the total number of units for sale, the market price will be 0. " \
                ...
                return "You provided a wrong answer to Question 3. Please provide the correct answer to proceed. If the total quantity bid for in your group exceeds the quantity for sale, the goods will be allotted from the highest bidding price to lower prices until all the units are allocated. " \
                ...
                return "You provided a wrong answer to Question 4. Please provide the correct answer to proceed. Points earnings = (the per unit market value - the market price) x the number of units allocated"
            else:
